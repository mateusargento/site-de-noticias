...
export async function getServerSideProps(ctx: any) {
  ...
  // ID 4 é da Copa Libertadores
  const axiosResult = await axios.listChampionship({ id: 4 })
...
export default function Clubes({
  ...
  const championship = `Copa Libertadores`.replaceAll('<!-- -->', '')
  ...
  const [allMatchWeeks, setAllMatchWeeks] = useState<{ key: string, label: string }[]>([
    ...
    { key: 'secondQualifyRound', label: 'Segunda Fase' },
    { key: 'thirdQualifyRound', label: 'Terceira Fase' },
  ...
  return (
    <main>
      ...
      {/* Título da página */}
      <TableTitle param='copa-libertadores' />
      ...
      >
        ...
        <SwiperSlide className={style.swiperSlide}>
          <QualifyMatches matches={matches} stage='firstQualifyRound' />
        </SwiperSlide>

        {/* Segunda fase */}
        <SwiperSlide className={style.swiperSlide}>
          <QualifyMatches matches={matches} stage='secondQualifyRound' />
        </SwiperSlide>

        {/* Terceira fase */}
        <SwiperSlide className={style.swiperSlide}>
          <QualifyMatches matches={matches} stage='thirdQualifyRound' />
        </SwiperSlide>
        ...
        <SwiperSlide className={style.swiperSlide}>
          ...
          <div className={style.caption}>
            ...
            <div className={style.list}>
              <p>
                Verde (1º ao 2º): Classificado |
                Azul (3º): Sul-Americana
              </p>
            </div>
          </div>
        </SwiperSlide>
