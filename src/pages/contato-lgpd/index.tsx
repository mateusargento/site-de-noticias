...
import style from './ContatoLGPD.module.scss'
import { Nunito_Sans } from 'next/font/google'

const nunito_sans = Nunito_Sans({ subsets: ['latin'] })

export default function ContatoLGPD() {
    const [name, setName] = useState<string>('')
    const [email, setEmail] = useState<string>('')
    const [subject, setSubject] = useState<string>('LGPD')
    ...
    return (
        <main>
            <Head>
                <title>Contato sobre LGPD - Nome da Empresa</title>
                <meta name="description" content="Área de contato exclusivo assuntos relacionados a LGPD." />

                {/* Google / Search Engine Tags */}
                <meta itemProp="name" content="Contato sobre LGPD - Nome da Empresa" />
                <meta itemProp="description" content="Área de contato exclusivo assuntos relacionados a LGPD." />
                ...
                <meta property="og:title" content="Contato sobre LGPD - Nome da Empresa" />
                <meta property="og:description" content="Área de contato exclusivo assuntos relacionados a LGPD." />
                <meta property="og:image" content={`${process.env.SERVERDOMAIN}/public/images/logo.png`} />

                {/* Twitter Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="Contato sobre LGPD - Nome da Empresa" />
                <meta name="twitter:description" content="Área de contato exclusivo assuntos relacionados a LGPD." />
                <meta name="twitter:image" content={`${process.env.SERVERDOMAIN}/public/images/logo.png`} />
            </Head>

            {/* Título da página */}
            <h1 className={"title"}>CONTATO SOBRE LGPD</h1>
